...
class Anuncios {
    ...
    public static function addCar($cuenta, $descripcion, $precio, $marca, $modelo, $año){
        ...
        $result = DB::executeSQL("INSERT INTO anuncios(idanuncios, nombre_anuncio, descripcion_anuncio, precio_anuncio, coche_anuncio, modelo_anuncio,año_vehiculo_anuncio) VALUES (0,?,?,?,?,?,?)",[$cuenta, $descripcion, $precio, $marca, $modelo, $año]);
