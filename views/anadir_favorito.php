...
<body>
    ...
    <form action="../addFavorito.php" id='loginForm' class="my-4" name="addForm" method='post' enctype="multipart/form-data" style="width:30%; font-family: 'Arial'">
